...
if __name__ == '__main__':
    ...
    elif args.network == 'attentionINCNNC':
        muda = jojo.GioGioModulateKernelInputDepthDINoCross(args.classNumber)
    elif args.network == 'attentionINDP':
        muda = jojo.AttentionDIDepthNet(args.classNumber)
    elif args.network == 'vanillapaperddi':
        muda = jojo.VanillaDepthDINetworkPaper(args.classNumber)
