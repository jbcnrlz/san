...
def standartParametrization(parser):
    ...
    parser.add_argument('--pathtrainingfile', default=None, help='Path for the training file', required=False)
    parser.add_argument('--parcal', default=False, type=bool, help='Should execute in parallell mode?',
                        required=False)
    parser.add_argument('--points', type=int, default=None, help='Quantity of points', required=False)
    parser.add_argument('--radius', type=int, default=None, help='Quantity of points', required=False)
    parser.add_argument('-s', '--steps', default=None,
                        ...
                        required=False)
    parser.add_argument('-gImg', '--pathImages',help='Path for image signature', required=True)
...
def separate_bn_paras(modules):
    ...
    for layer in modules:
        if 'networks' in str(layer.__class__):
            continue
